...
class Tag extends \Sulu\Bundle\TagBundle\Entity\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'name', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'id', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'created', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'changed', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'changer', '' . "\0" . 'Sulu\\Bundle\\TagBundle\\Entity\\Tag' . "\0" . 'creator', 'apiBasePath', 'apiPath'];
        }
