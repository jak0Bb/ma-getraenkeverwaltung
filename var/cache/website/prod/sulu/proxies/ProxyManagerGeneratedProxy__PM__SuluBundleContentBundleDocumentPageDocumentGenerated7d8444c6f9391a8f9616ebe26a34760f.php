...
namespace ProxyManagerGeneratedProxy\__PM__\Sulu\Bundle\ContentBundle\Document\PageDocument;

class Generated7d8444c6f9391a8f9616ebe26a34760f extends \Sulu\Bundle\ContentBundle\Document\PageDocument implements \ProxyManager\Proxy\GhostObjectInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5b5846f9225cc213842130 = null;

    /**
     * @var bool tracks initialization status - true while the object is initializing
     */
    private $initializationTracker5b5846f9225d3236006563 = false;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b5846f922575885905542 = [
     ...
     */
    private static $privateProperties5b5846f92258c988685921 = [
        'parent' => [
            'Sulu\\Bundle\\ContentBundle\\Document\\PageDocument' => true,
        ],
    ];
     ...
     * property name
     */
    private static $protectedProperties5b5846f92259b433125980 = [
    ...
    private static $signature7d8444c6f9391a8f9616ebe26a34760f = '';
     ...
     * @return mixed
     */
    private function callInitializer5b5846f9225dd550686092($methodName, array $parameters)
    {
        if ($this->initializationTracker5b5846f9225d3236006563 || ! $this->initializer5b5846f9225cc213842130) {
            return;
        }
        
        $this->initializationTracker5b5846f9225d3236006563 = true;
        ...
        $this->authored = NULL;
        $this->author = NULL;
        static $cacheSulu_Bundle_ContentBundle_Document_PageDocument;

        $cacheSulu_Bundle_ContentBundle_Document_PageDocument ?: $cacheSulu_Bundle_ContentBundle_Document_PageDocument = \Closure::bind(function ($instance) {
            $instance->parent = NULL;
        }, null, 'Sulu\\Bundle\\ContentBundle\\Document\\PageDocument');

        $cacheSulu_Bundle_ContentBundle_Document_PageDocument($this);
        ...
        static $cacheFetchSulu_Bundle_ContentBundle_Document_PageDocument;

        $cacheFetchSulu_Bundle_ContentBundle_Document_PageDocument ?: $cacheFetchSulu_Bundle_ContentBundle_Document_PageDocument = \Closure::bind(function ($instance, array & $properties) {
            $properties['' . "\0" . 'Sulu\\Bundle\\ContentBundle\\Document\\PageDocument' . "\0" . 'parent'] = & $instance->parent;
        }, $this, 'Sulu\\Bundle\\ContentBundle\\Document\\PageDocument');

        $cacheFetchSulu_Bundle_ContentBundle_Document_PageDocument($this, $properties);
        
        $result = $this->initializer5b5846f9225cc213842130->__invoke($this, $methodName, $parameters, $this->initializer5b5846f9225cc213842130, $properties);
        $this->initializationTracker5b5846f9225d3236006563 = false;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        \Closure::bind(function (\Sulu\Bundle\ContentBundle\Document\PageDocument $instance) {
            unset($instance->parent);
        }, $instance, 'Sulu\\Bundle\\ContentBundle\\Document\\PageDocument')->__invoke($instance);

        $instance->initializer5b5846f9225cc213842130 = $initializer;
    ...
    {
        $this->initializer5b5846f9225cc213842130 && ! $this->initializationTracker5b5846f9225d3236006563 && $this->callInitializer5b5846f9225dd550686092('__get', array('name' => $name));
        
        if (isset(self::$publicProperties5b5846f922575885905542[$name])) {
            return $this->$name;
        }
        
        if (isset(self::$protectedProperties5b5846f92259b433125980[$name])) {
            if ($this->initializationTracker5b5846f9225d3236006563) {
                return $this->$name;
            }
            ...
            $expectedType = self::$protectedProperties5b5846f92259b433125980[$name];
        ...
        } elseif (isset(self::$privateProperties5b5846f92258c988685921[$name])) {
            ...
            if (isset(self::$privateProperties5b5846f92258c988685921[$name][$class])) {
                $cacheKey = $class . '#' . $name;
            ...
            if ($this->initializationTracker5b5846f9225d3236006563 || 'ReflectionProperty' === $class) {
                $tmpClass = key(self::$privateProperties5b5846f92258c988685921[$name]);
    ...
    {
        $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('__set', array('name' => $name, 'value' => $value));
    ...
    {
        $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('__isset', array('name' => $name));
    ...
    {
        $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('__unset', array('name' => $name));
    ...
    {
        $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('__clone', []);
    }

    public function __sleep()
    {
        $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('__sleep', []);
    ...
    {
        $this->initializer5b5846f9225cc213842130 = $initializer;
    }
    ...
    {
        return $this->initializer5b5846f9225cc213842130;
    }
    ...
    {
        return $this->initializer5b5846f9225cc213842130 && $this->callInitializer5b5846f9225dd550686092('initializeProxy', []);
    }
