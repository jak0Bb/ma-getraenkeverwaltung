...
class Generated8c28ca2d2a1b982efebca9ee487af5a6 extends \Sulu\Bundle\ContentBundle\Document\HomeDocument implements \ProxyManager\Proxy\GhostObjectInterface
{
     ...
     */
    private $initializer5b4f273b119b4333851659 = null;

    /**
     * @var bool tracks initialization status - true while the object is initializing
     */
    private $initializationTracker5b4f273b11ac4301215801 = false;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b4f273b11042859634044 = [
     ...
     */
    private static $privateProperties5b4f273b1160a041744292 = [
     ...
     * property name
     */
    private static $protectedProperties5b4f273b11769736791142 = [
     ...
     * @return mixed
     */
    private function callInitializer5b4f273b1206d324798388($methodName, array $parameters)
    {
        if ($this->initializationTracker5b4f273b11ac4301215801 || ! $this->initializer5b4f273b119b4333851659) {
            return;
        }

        $this->initializationTracker5b4f273b11ac4301215801 = true;
        ...
        $result = $this->initializer5b4f273b119b4333851659->__invoke($this, $methodName, $parameters, $this->initializer5b4f273b119b4333851659, $properties);
        $this->initializationTracker5b4f273b11ac4301215801 = false;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5b4f273b119b4333851659 = $initializer;
    ...
    {
        $this->initializer5b4f273b119b4333851659 && ! $this->initializationTracker5b4f273b11ac4301215801 && $this->callInitializer5b4f273b1206d324798388('__get', array('name' => $name));

        if (isset(self::$publicProperties5b4f273b11042859634044[$name])) {
            return $this->$name;
        }

        if (isset(self::$protectedProperties5b4f273b11769736791142[$name])) {
            if ($this->initializationTracker5b4f273b11ac4301215801) {
                return $this->$name;
            }
            ...
            $expectedType = self::$protectedProperties5b4f273b11769736791142[$name];
        ...
        } elseif (isset(self::$privateProperties5b4f273b1160a041744292[$name])) {
            ...
            if (isset(self::$privateProperties5b4f273b1160a041744292[$name][$class])) {
                $cacheKey = $class . '#' . $name;
            ...
            if ($this->initializationTracker5b4f273b11ac4301215801 || 'ReflectionProperty' === $class) {
                $tmpClass = key(self::$privateProperties5b4f273b1160a041744292[$name]);
    ...
    {
        $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('__set', array('name' => $name, 'value' => $value));
    ...
    {
        $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('__isset', array('name' => $name));
    ...
    {
        $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('__unset', array('name' => $name));
    ...
    {
        $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('__clone', []);
    }

    public function __sleep()
    {
        $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('__sleep', []);
    ...
    {
        $this->initializer5b4f273b119b4333851659 = $initializer;
    }
    ...
    {
        return $this->initializer5b4f273b119b4333851659;
    }
    ...
    {
        return $this->initializer5b4f273b119b4333851659 && $this->callInitializer5b4f273b1206d324798388('initializeProxy', []);
    }
