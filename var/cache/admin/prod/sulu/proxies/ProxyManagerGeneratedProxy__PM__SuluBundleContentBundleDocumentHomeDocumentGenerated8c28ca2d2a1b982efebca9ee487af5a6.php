...
class Generated8c28ca2d2a1b982efebca9ee487af5a6 extends \Sulu\Bundle\ContentBundle\Document\HomeDocument implements \ProxyManager\Proxy\GhostObjectInterface
{
     ...
     */
    private $initializer5b58453ee7980946540466 = null;

    /**
     * @var bool tracks initialization status - true while the object is initializing
     */
    private $initializationTracker5b58453ee7a78646661564 = false;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5b58453ee6ec1654165669 = [
     ...
     */
    private static $privateProperties5b58453ee750e415562456 = [
     ...
     * property name
     */
    private static $protectedProperties5b58453ee76e2141445477 = [
     ...
     * @return mixed
     */
    private function callInitializer5b58453ee7f05434165687($methodName, array $parameters)
    {
        if ($this->initializationTracker5b58453ee7a78646661564 || ! $this->initializer5b58453ee7980946540466) {
            return;
        }
        
        $this->initializationTracker5b58453ee7a78646661564 = true;
        ...
        $result = $this->initializer5b58453ee7980946540466->__invoke($this, $methodName, $parameters, $this->initializer5b58453ee7980946540466, $properties);
        $this->initializationTracker5b58453ee7a78646661564 = false;
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5b58453ee7980946540466 = $initializer;
    ...
    {
        $this->initializer5b58453ee7980946540466 && ! $this->initializationTracker5b58453ee7a78646661564 && $this->callInitializer5b58453ee7f05434165687('__get', array('name' => $name));
        
        if (isset(self::$publicProperties5b58453ee6ec1654165669[$name])) {
            return $this->$name;
        }
        
        if (isset(self::$protectedProperties5b58453ee76e2141445477[$name])) {
            if ($this->initializationTracker5b58453ee7a78646661564) {
                return $this->$name;
            }
            ...
            $expectedType = self::$protectedProperties5b58453ee76e2141445477[$name];
        ...
        } elseif (isset(self::$privateProperties5b58453ee750e415562456[$name])) {
            ...
            if (isset(self::$privateProperties5b58453ee750e415562456[$name][$class])) {
                $cacheKey = $class . '#' . $name;
            ...
            if ($this->initializationTracker5b58453ee7a78646661564 || 'ReflectionProperty' === $class) {
                $tmpClass = key(self::$privateProperties5b58453ee750e415562456[$name]);
    ...
    {
        $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('__set', array('name' => $name, 'value' => $value));
    ...
    {
        $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('__isset', array('name' => $name));
    ...
    {
        $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('__unset', array('name' => $name));
    ...
    {
        $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('__clone', []);
    }

    public function __sleep()
    {
        $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('__sleep', []);
    ...
    {
        $this->initializer5b58453ee7980946540466 = $initializer;
    }
    ...
    {
        return $this->initializer5b58453ee7980946540466;
    }
    ...
    {
        return $this->initializer5b58453ee7980946540466 && $this->callInitializer5b58453ee7f05434165687('initializeProxy', []);
    }
