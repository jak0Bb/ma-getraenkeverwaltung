...
class websiteProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $e->addEventSubscriber(${($_ = isset($this->services['sulu.persistence.event_subscriber.orm.user_blame']) ? $this->services['sulu.persistence.event_subscriber.orm.user_blame'] : $this->services['sulu.persistence.event_subscriber.orm.user_blame'] = new \Sulu\Component\Persistence\EventSubscriber\ORM\UserBlameSubscriber(NULL, 'Sulu\\Bundle\\SecurityBundle\\Entity\\User')) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_e44cde8465eacda6b2e13104f3b9f56fd6cd0b5ccd44caa2154a509a9a6a3a30');
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[3].'\\logs\\preview/prod.log'), 100, true, NULL);
    ...
    protected function getSuluDocumentManager_EventDispatcherService()
    {
        ...
        $instance->addListener('sulu_document_manager.configure_options', array(0 => function () {
            return ${($_ = isset($this->services['sulu_document_manager.subscriber.security']) ? $this->services['sulu_document_manager.subscriber.security'] : $this->services['sulu_document_manager.subscriber.security'] = new \Sulu\Bundle\DocumentManagerBundle\Document\Subscriber\SecuritySubscriber(NULL)) && false ?: '_'};
        }, 1 => 'setDefaultUser'), 0);
        $instance->addListener('sulu_document_manager.configure_options', array(0 => function () {
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.logs_dir': $value = ($this->targetDirs[3].'\\logs\\preview'); break;
