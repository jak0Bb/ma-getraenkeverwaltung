...
class websiteDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_156dfb499344f09b7e291b501f08839aaba8373ba7c9d0fc72cba59b6048fe15');
    ...
    {
        $this->services['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[3].'\\logs\\preview/dev.log'), 100, true, NULL);
    ...
    protected function getSuluWebsite_Translator_RequestAnalyzerService()
    {
        ...
        return $this->services['sulu_website.translator.request_analyzer'] = new \Sulu\Bundle\WebsiteBundle\Translator\RequestAnalyzerTranslator(new \Symfony\Component\Translation\LoggingTranslator(${($_ = isset($this->services['translator.default']) ? $this->services['translator.default'] : $this->getTranslator_DefaultService()) && false ?: '_'}, ${($_ = isset($this->services['monolog.logger.translation']) ? $this->services['monolog.logger.translation'] : $this->getMonolog_Logger_TranslationService()) && false ?: '_'}), $a);
    }
